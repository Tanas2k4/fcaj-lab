...
- **Điểm cộng**:
  ...
  * Cấu hình Memory/Timeout độc lập (hàm tính toán nặng cấp 1,024MB RAM, hàm nhẹ chỉ cần 128MB).
...
- **Lambda Ghi (Command/Write Operations)**: Gom các request thay đổi trạng thái hệ thống (POST, PUT, DELETE, PATCH).
...
- **Lambda Đọc (Query/Read Operations)**: Xử lý thuần túy luồng GET.
...
### Tách biệt luồng Đọc/Ghi cho Serverless API

![Tách biệt luồng Đọc/Ghi cho Serverless API](/images/blogs/blog3-Picture1.png)
*Hình 1: Kiến trúc chia tách cơ bản thành 2 Lambda chuyên biệt.*
...
### Tiến hóa lên CQRS và Kiến trúc hướng sự kiện

![Tiến hóa lên CQRS và Kiến trúc hướng sự kiện](/images/blogs/blog3-Picture2.png)
*Hình 2: Sơ đồ kiến trúc CQRS hoàn chỉnh với SQS, Lambda và Replica Databases.*
...
**Nguồn:** [AWS Compute Blog](https://aws.amazon.com/blogs/compute/comparing-design-approaches-for-building-serverless-microservices/)

**Bài viết trên AWS Study Group:** [AWS Compute Blog](https://www.facebook.com/groups/awsstudygroupfcj/permalink/2203819477049679/?rdid=3sEML8B3PXziCwcs#)